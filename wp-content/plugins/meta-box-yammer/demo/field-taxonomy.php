...
if ( ! class_exists( 'RWMBYY_Taxonomy_Field' ) )
{
	/**
	...
	class RWMBYY_Taxonomy_Field
	{
		...
		static function admin_print_styles()
		{
			wp_enqueue_style(
				'rwmby-taxonomy',
				RWMBYY_CSS_URL . 'taxonomy.css',
				RWMBYY_VER
			);
			wp_enqueue_script(
				'rwmby-taxonomy',
				RWMBYY_JS_URL . 'taxonomy.js',
		...
		static function walk_select_tree( $meta, $field, $elements, $parent = 0, $parent_slug='', $active = false )
		{
			...
			{
				$id = "id='rwmby-taxonomy-{$parent_slug}'";
			}
	...
	} // END Class RWMBYY_Taxonomy_Field
} // endif;

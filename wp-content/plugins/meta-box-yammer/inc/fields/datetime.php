...
if ( ! class_exists( 'RWMBY_Datetime_Field' ) )
{
	class RWMBY_Datetime_Field
	{
		/**
		...
		static function admin_print_styles( )
		{
			...
			wp_enqueue_script( 'rwmby-datetime', RWMBY_JS_URL . 'datetime.js', array( 'jquery-ui-timepicker' ), RWMBY_VER, true );
		}
		...
		static function html( $html, $meta, $field )
		{
			...
			$val   = " value='$meta'";
			$html .= "<input type='text' class='rwmby-datetime' size='30'{$name}{$id}{$rel}{$val} />";

...
if ( ! class_exists( 'RWMBY_Time_Field' ) )
{
	class RWMBY_Time_Field
	{
		/**
		...
		static function admin_print_styles( ) 
		{
			...
			wp_enqueue_script( 'rwmby-time', RWMBY_JS_URL.'time.js', array( 'jquery-ui-timepicker' ), RWMBY_VER, true );
		}
		...
		static function html( $html, $meta, $field ) 
		{
			...
			$val   = " value='$meta'";
			$html .= "<input type='text' class='rwmby-time' size='30'{$name}{$id}{$rel}{$val} />";

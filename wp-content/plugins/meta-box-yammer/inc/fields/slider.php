...
if ( ! class_exists( 'RWMBY_Slider_Field' ) )
{
	class RWMBY_Slider_Field
	{
		/**
		...
		static function admin_print_styles()
		{
			...
			wp_enqueue_script( 'rwmby-slider', RWMBY_JS_URL . 'slider.js', array( 'jquery-ui-slider' ), RWMBY_VER, true );
		}
		...
		static function html( $html, $meta, $field )
		{
			...
			$html   .= "
				<div class='clearfix'>
					<div class='rwmby-slider'{$format}{$id}></div>

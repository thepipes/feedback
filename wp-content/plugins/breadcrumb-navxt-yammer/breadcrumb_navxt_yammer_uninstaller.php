 ...
 * @author Tom Klingenberg
 */
abstract class bcn_yammer_uninstaller_abstract {
	 ...
	 * 				          e.g. 'breadcrumb-navxt/breadcrumb_navxt_yammer_admin.php'.
	 * @return this 
	 */
...
} /// class bcn_yammer_uninstaller_abstract
 ...
 * @author Tom Klingenberg
 */
class bcn_yammer_uninstaller extends bcn_yammer_uninstaller_abstract {
	 ...
	 * @var string plugin dirname
	 */
	protected $_base = 'breadcrumb-navxt-yammer';
	...
	{	
		...
		if(!class_exists('bcn_yammer_admin'))
			require_once($this->_getPluginPath());
			
		// uninstall		
		$bcn_yammer_admin->uninstall();
	}	
	...
	public function uninstall()
	{
		...
		switch($this->_plugin)
		{
			case 'breadcrumb_navxt_yammer_admin.php':
				return $this->_uninstallAdmin();
				
			case 'breadcrumb_navxt_yammer_class.php':
				return true;

<?php
/*
Plugin Name: Image Widget (Yammer)
...
function yammer_load_image_widget() {
	register_widget('Yammer_Image_Widget');
}
add_action('widgets_init', 'yammer_load_image_widget');

/**
 * Yammer_Image_Widget class
 **/
class Yammer_Image_Widget extends WP_Widget {
	 ...
	 *
	 * @author Modern Yammer, Inc. (Peter Chester)
	 */
	function Yammer_Image_Widget() {
		...
		$this->WP_Widget('widget_sp_image', __('Image Widget Yammer', $this->pluginDomain), $widget_ops, $control_ops);
		...
		if (defined("WP_ADMIN") && WP_ADMIN) {
			...
			if ( 'widgets.php' == $pagenow ) {
				...
				wp_enqueue_script( 'yammer-image-widget' );
	...
	function register_scripts_and_styles() {
		...
		wp_register_script( 'yammer-image-widget', $dir . 'image-widget.js', array('jquery','thickbox'), false, true );
	}
	 ...
	 * @author Modern Yammer, Inc. (Matt Wiebe)
	 **/

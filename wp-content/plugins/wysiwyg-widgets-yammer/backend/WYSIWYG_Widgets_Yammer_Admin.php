<?php
if (!class_exists('WYSIWYG_Widgets_Yammer_Admin')) {

    class WYSIWYG_Widgets_Yammer_Admin {

        var $hook = 'wysiwyg-widgets-yammer';
        var $longname = 'WYSIWYG Widgets (Yammer)';
        var $shortname = 'WYSIWYG Widgets (Yammer)';
        var $plugin_url = 'http://dannyvankooten.com/wordpress-plugins/wysiwyg-widgets/';
        var $filename = 'wysiwyg-widgets-yammer/wysiwyg-widgets-yammer.php';
        private $version = '1.1';
        ...
        function load_scripts() {
            ...
            wp_enqueue_script('wysiwyg-widgets-yammer', plugins_url('/backend/js/wysiwyg-widgets-yammer.js', dirname(__FILE__)), array('jquery', 'editor', 'thickbox', 'media-upload'), $this->version);
        }
        ...
        function load_styles() {
            ...
            wp_enqueue_style('wysiwyg-widgets-yammer', plugins_url('/backend/css/wysiwyg-widgets-yammer.css', dirname(__FILE__)));
        }

...
function roots_get_stylesheets() {
  ...
  if ($roots_options['development']) {
    ...
    $styles .= stylesheet_link_tag('/yammer/yammer.css');
  }
  echo $styles;
}
...
function roots_google_analytics() {
  ...
  if ($roots_google_analytics_id !== '') {
    echo "\n\t<script>\n";
    echo "\tvar _gaq = _gaq || [];\n";
    echo "\t_gaq.push(['_setAccount', '$get_roots_google_analytics_id']);\n";
    echo "\t_gaq.push(['_setDomainName', 'yammer.com']);\n";

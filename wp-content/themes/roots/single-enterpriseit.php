<?php
/*
Template Description: enterprise it page template for enterprise it post type
*/
get_header(); ?>
...
<?php //check if the post has a featured thumbnail and set the main content area's background to it ?>
  ...
  <?php get_template_part( 'heading' );           // heading section (heading.php) ?>
    ...
    <?php roots_loop_before(); ?>
      ...
      <?php get_template_part( 'panel-template', 'enterpriseit' );           // reusable product template (panel-template-product-features.php) ?>
